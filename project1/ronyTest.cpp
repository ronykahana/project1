...
Project1::Product::Product(const char *brand, const char *name,
  ...
  // char *strcpy(char brand, const char *brand);
...
const char *Project1::Product::getBrand() const {
  // TODO: Implement
  return brand;
}
...
const char *Project1::Product::getName() const {
  // TODO: Implement
  return name;
}
...
const char *Project1::Product::getSize() const {
  // TODO: Implement
  return size;
}
